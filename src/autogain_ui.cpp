...
AutoGainUi::AutoGainUi(BaseObjectType* cobject,
  ...
  builder->get_widget("use_custom_integrated_value", use_custom_integrated_value);
  ...
  get_object(builder, "custom_integrated_value", custom_integrated_value);
  ...
  settings->bind("custom_integrated-value", custom_integrated_value.get(), "value", flag);
  settings->bind("detect-silence", detect_silence, "active", flag);
  settings->bind("use-custom-integrated-value", use_custom_integrated_value, "active", flag);
