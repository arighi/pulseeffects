...
class AutoGainUi : public Gtk::Grid, public PluginUiBase {
 ...
 private:
  Glib::RefPtr<Gtk::Adjustment> input_gain, output_gain, target, weight_m, weight_s, weight_i, custom_integrated_value;
  ...
  Gtk::ToggleButton *detect_silence = nullptr, *use_geometric_mean = nullptr, *use_custom_integrated_value = nullptr;
